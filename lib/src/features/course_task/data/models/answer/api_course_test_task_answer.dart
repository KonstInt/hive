...
abstract class ApiCourseTestTaskAnswer with _$ApiCourseTestTaskAnswer {
  factory ApiCourseTestTaskAnswer.fromText(
      ...
      String? imageUrl}) = _ApiCourseTestTaskAnswerFromText;
  ...
  factory ApiCourseTestTaskAnswer.fromJson(Map<String, dynamic> json) =>
      _$ApiCourseTestTaskAnswerFromJson(json);
}
