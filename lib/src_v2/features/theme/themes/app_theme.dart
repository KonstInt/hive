...
class AppTheme {
  ...
  static const ColorsPalette lightPalette = ColorsPalette(
    ...
    disabled: Color.fromARGB(255, 140, 140, 140),
    baseText: Color(0xFF000000),
    inverseText: Color(0xFFFFFFFF),
    primaryBackground: Color(0xFFFFFFFF),
    secondaryBackground: Color.fromARGB(255, 249, 249, 249),
    thirdlyBackground: Color(0x0A000000),
  );
  ...
  static const ColorsPalette darkPalette = ColorsPalette(
      ...
      violet: Color(0xFF505ADD),
      disabled: Color.fromARGB(255, 126, 126, 126),
      baseText: Color.fromARGB(211, 232, 231, 231),
      inverseText: Color(0xFF000000),
      primaryBackground: Color.fromARGB(255, 74, 74, 74),
      secondaryBackground: Color.fromARGB(168, 64, 64, 64),
      thirdlyBackground: Color.fromARGB(248, 0, 0, 0));
